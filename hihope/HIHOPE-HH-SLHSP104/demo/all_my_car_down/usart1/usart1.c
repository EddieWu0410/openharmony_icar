...
//         Usart1_on_recv(g_rx_buffer, g_rx_cnt);
...
// volatile uint8_t usart1_data[30];
// volatile uint8_t usart1_recv_len=0;
// volatile uint8_t recv_finish_flag=0;
// volatile uint8_t len_loc=2;
// void USART1_IRQHandler(void)
// {
...
//     data = usart_data_receive(USART1);
//     // Upper_Data_Receive(data);
//     usart1_data[usart1_recv_len]=data;
//     usart1_recv_len++;
//     if(usart1_recv_len>=4&&
//       usart1_recv_len==usart1_data[len_loc]-2)
//       {
//         recv_finish_flag=1;
//       }
//   }
...
// volatile uint8_t* Get_recv_data()
// {
//   return usart1_data;
// }

// volatile uint8_t GET_finish_flag()
// {
//   return recv_finish_flag;
// }
