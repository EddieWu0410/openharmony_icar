...
osThreadId_t message_newThread(char *name, osThreadFunc_t func, char *arg)
{
    osThreadAttr_t attr = {
...
void rtosv2_msgq_main(void)
{
    ...
    osThreadId_t ctid1 = message_newThread("recevier1", receiver_thread, NULL);
    osThreadId_t ctid2 = message_newThread("recevier2", receiver_thread, NULL);
    osThreadId_t ptid1 = message_newThread("sender1", sender_thread, NULL);
    osThreadId_t ptid2 = message_newThread("sender2", sender_thread, NULL);
    osThreadId_t ptid3 = message_newThread("sender3", sender_thread, NULL);
