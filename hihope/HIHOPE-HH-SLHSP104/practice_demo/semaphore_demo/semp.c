...
osThreadId_t semp_newThread(char *name, osThreadFunc_t func, char *arg)
{
    osThreadAttr_t attr = {
...
void rtosv2_semp_main(void)
{
    ...
    osThreadId_t ptid1 = semp_newThread("producer1", producer_thread, NULL);
    osThreadId_t ptid2 = semp_newThread("producer2", producer_thread, NULL);
    osThreadId_t ptid3 = semp_newThread("producer3", producer_thread, NULL);
    osThreadId_t ctid1 = semp_newThread("consumer1", consumer_thread, NULL);
    osThreadId_t ctid2 = semp_newThread("consumer2", consumer_thread, NULL);
